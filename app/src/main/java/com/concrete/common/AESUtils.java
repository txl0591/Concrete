...
{
    private static final String keyBytes="CoreSoft13140000";
    private static final String ivBytes="CoreSoft13140000";
    ...
    private static byte[] encrypt(String content, String password) {
        try {
            ...
            IvParameterSpec ivSpec = new IvParameterSpec(ivBytes.getBytes());
    ...
    public static String encode(String content){
        ...
        byte[] a = encrypt(content, keyBytes);
        if(a != null) {
            return new String(Base64.encode(a, Base64.DEFAULT));
        }else
        {
            return "null";
        }
